...
```
npm create cloudflare@latest -- --template=cloudflare/templates/schoolgroupchat
```

A live public deployment of this template is available at [https://schoolgroupchat.templates.workers.dev](https://schoolgroupchat.templates.workers.dev)
